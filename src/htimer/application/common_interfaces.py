...
class Clock(Protocol):
    ...
    ) -> None | common_exceptions.InvalidDate:
        pass
...
class FileRepository(Protocol):
    ...
    ) -> list[entities.DailyLogFile] | common_exceptions.RepositoryError:
        pass
...
class PaymentGateway(Protocol):
    ...
    async def refund_payment(
        self, payment: entities.Payment, gateway_payment_id: str
    ) -> (
        bool
...
class JobGateway(Protocol):
    ...
    async def publish_report(
        self, report_id: UUID
    ) -> None | common_exceptions.RepositoryError | common_exceptions.JobGatewayError:
        pass
