...
from . import exceptions as db_exceptions
...
class ProjectRepository(common_interfaces.ProjectRepository):
    ...
    async def remove_members(
        ...
        return _map_exception(
            await self._db_rep.remove_members(project_uuid, members_uuids)
        )
...
class StageRepository(common_interfaces.StageRepository):
    ...
    async def get_by_name(
        ...
        return _map_exception(
            await self._db_rep.get_by_name(project_uuid, stage_name, lock_record)
        )
    ...
    async def delete(
        ...
        None | common_exceptions.StageNotFoundError | common_exceptions.RepositoryError
    ):
...
class DailyLogRepository(common_interfaces.DailyLogRepository):
    ...
    async def get_list_by_project(
        ...
        return _map_exception(
            await self._db_rep.get_list_by_project(
                project_uuid, start_date, end_date, users_uuid, draft
            )
        )
...
class TaskRepository(common_interfaces.TaskRepository):
    ...
    async def delete(
        self, task_uuid: UUID
    ) -> None | common_exceptions.TaskNotFoundError | common_exceptions.RepositoryError:
...
class PaymentRepository(common_interfaces.PaymentRepository):
    ...
    async def get_gateway_payment_id(
        ...
        str | common_exceptions.PaymentNotFoundError | common_exceptions.RepositoryError
    ):
    ...
    async def payment_applied_to_subscription(
        ...
        return _map_exception(
            await self._db_rep.payment_applied_to_subscription(payment_uuid)
        )
...
class SubscriptionRepository(common_interfaces.SubscriptionRepository):
    ...
    async def get_by_project_uuid(
        ...
        return _map_exception(
            await self._db_rep.get_by_project_uuid(project_uuid, lock_record)
        )
