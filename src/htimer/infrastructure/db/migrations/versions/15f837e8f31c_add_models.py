...
def upgrade() -> None:
    ...
    stagestatus_enum = postgresql.ENUM(
        "ACTIVE",
        "COMPLETED",
        "ARCHIVED",
        name="stagestatus",
    ...
    op.create_table(
        ...
        sa.Column(
            "parent_uuid",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("stages.uuid", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column("created_at", sa.Date(), nullable=False),
        ...
        sa.CheckConstraint(
            "main_path OR parent_uuid IS NOT NULL", name="ck_stage_main_path_boolean"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "subscription_uuid",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("subscriptions.uuid", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "daily_log_uuid",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("daily_logs.uuid", ondelete="CASCADE"),
            nullable=False,
        ),
    )
