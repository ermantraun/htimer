...
class ProjectAuthorizationPolicyImpl(interfaces.ProjectAuthorizationPolicy):
    def decide_create_project(
    ...
    ) -> project_exceptions.UserNotAdminError | None:
        ...
        if (
            error
            is entities.UserDecisions.CreateProjectDecision.FORBIDDEN_FOR_NON_ADMIN
        ):
    ...
    def decide_update_project(
    ...
    ) -> project_exceptions.UserNotProjectAdminError | None:
        ...
        if (
            error
            is entities.UserDecisions.UpdateProjectDecision.FORBIDDEN_FOR_NON_PROJECT_ADMIN_OR_CREATOR
        ):
    ...
    def decide_get_project(
        ...
        project: entities.Project,
        members: list[entities.User],
    ) -> project_exceptions.UserNotProjectMemberError | None:
