...
class UpdateDailyLogValidator:
    ...
    def validate(self, data: dto.UpdateDailyLogInDTO) -> None | exceptions.DayliLogValidationError:
        if data.description is None and data.hours_spent is None and data.substage_uuid is None:
